...
class addonDesc:
    ...
    def __init__(self, addonDescPath):
        if os.path.exists(addonDescPath) and os.path.isfile(addonDescPath):
            jsonAddonDesc = json.load(open(addonDescPath))
            ...
            installerDir = addonDescPath.split("installer/addons")[0] + "/installer/"
            envDir = addonDescPath.split("CC")[0]
            ...
            raise FileNotFoundError(os.path.abspath(addonDescPath))