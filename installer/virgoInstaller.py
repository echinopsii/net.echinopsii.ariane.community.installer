...
from addons.addonInstaller import addonInstaller, addonProcessor
...
def parse():
    ...
    group.add_argument('-i', '--install', help='Install Ariane addons packages', nargs='+')
    group.add_argument('-k', '--check', help="Check Ariane addons packages", nargs="+")
    group.add_argument('-l', '--list', help='List installed Ariane addons', action='store_true')
    #todo: special action to validate addons id to uninstall
    group.add_argument('-u', '--uninstall', help='Uninstall Ariane addon', nargs=2, metavar=("addon_name", "addon_version"))
...
if __name__ == "__main__":
    ...
    if args.autoconfigure:
        ...
        addonProcessor = addonProcessor(virgoHomeDirAbsPath, directoryProcessor.directoryDBConfig, idmProcessor.idmDBConfig, True).process()
        print("\n%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--\n")
        ...
        for addonCmdsFilePath in addonProcessor.getDeployCommandsFiles():
            call(["java", "-cp", classpath, mainClass, ssh.get('hostname'), ssh.get('port'), ssh.get('username'), ssh.get('password'), addonCmdsFilePath])
        sleep(60)
        ...
        license(True)
        print("%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--\n")
        print("%-- Check if provided Ariane addon package(s) is/are valid :")
        for addon in args.check:
            ret = addonInstaller(virgoHomeDirAbsPath).checkAddonPackage(addon)
            if ret is True:
                print("\n%-- Ariane addon package " + addon + " is valid !")
            else:
                print("\n%-- Ariane addon package " + addon + " is NOT valid ! Reason : " + ret)
        print("\n%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--\n")
        ...
        addonProcessor = addonProcessor(virgoHomeDirAbsPath, directoryProcessor.directoryDBConfig, idmProcessor.idmDBConfig, False).process()
        print("\n%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--\n")
        print("%-- Ariane configuration is done !\n")
        ...
        license(True)
        print("%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--\n")
        print("%-- Install provided Ariane addon package(s) is/are valid :")
        for addon in args.install:
            addonInstaller(virgoHomeDirAbsPath).installAddonPackage(addon)
        print("\n%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--\n")

    elif args.list:
        license(True)
        print("%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--\n")
        print("%-- List of installed Ariane addon(s) in " + virgoHomeDirAbsPath + " :")
        addonInstaller(virgoHomeDirAbsPath).listInstalledAddonPackages()
        print("\n%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--\n")

    elif args.uninstall is not None:
        license(True)
        print("%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--\n")
        print("%-- Uninstall Ariane addon :")
        addonInstaller(virgoHomeDirAbsPath).uninstallAddonPackage(args.uninstall[0], args.uninstall[1])
        print("\n%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--%--\n")
